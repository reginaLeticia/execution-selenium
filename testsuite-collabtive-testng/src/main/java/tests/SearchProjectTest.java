...
public class SearchProjectTest {
	...
	public void testCollabtiveSearchProject(String port, String host) throws Exception {
		int i = 0;
		//for(int i=0; i<data.length; i++) {
			...
			assertEquals(data[i][0], driver.findElement(By.xpath("html/body/div[1]/div[2]/div[2]/div/div/div[2]/div[2]/div/div/ul/li/div/table/tbody/tr[2]/td/span/a")).getText());
			Thread.sleep(1000);
